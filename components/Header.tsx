            ...
            <div className='col-span-12 mx-auto mb-4 sm:col-span-8 sm:mx-0 sm:my-auto sm:ml-auto sm:mr-4'>
                <form method='GET' className='flex items-end'>
                    ...
                    <div className='my-auto relative'>
                        <label className='input input-bordered ml-auto flex items-center gap-2 w-full' onFocus={()=>setFocus(true)} onBlur={()=>setFocus(false)}>
                            <input
                                type='text'
                        ...
                        {query!==""&&focus?<div className='absolute top-full left-0 w-full bg-white rounded-lg shadow-md'>
